...
const Benefits = () => (
  <section className=" p-20  bg-stone-100">
    <div className="container">
      <div className="text-center max-w-3xl mx-auto mb-20">
        ...
        <h2 className="text-4xl lg:text-4xl font-light tracking-wide text-foreground mb-8 leading-tight text-balance">
          Deep Tissue &amp; Therapeutic Sports Massage: What They&apos;re Known
          For
        </h2>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-16 mt-20">
        <div className="border border-[#f0cc75] p-10 md:p-14">
          <p className=" text-xl md:text-2xl mt-3 mb-8 text-center">
      ...
      <p className="mt-10 max-w-3xl mx-auto text-center text-[#121212] leading-relaxed  text-[17px]">
      ...
      <div className="mt-8 text-center">
        <button className="bg-[#f0cc75] uppercase hover:bg-accent/90 text-black px-8 py-4 mt-8 font-medium tracking-wide transition-colors w-fit">
          Take the Next Step
        </button>
      </div>
    </div>
