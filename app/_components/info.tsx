...
const Info = () => {
  return (
    <div>
      <section className="bg-background p-30 bg-stone-50">
          ...
          <div className="  flex flex-col justify-center order-1 lg:order-2">
            ...
            <div className="space-y-6 text-base lg:text-[17px] leading-relaxed text-foreground/90 font-light">
              ...
              <p>
                ...
                Bodies with above-average self-care awareness need massage
                therapy providers who understand that difference.
              </p>

              <p>
                At Mudras, we go beyond standard massage therapy by offering a
                level of customization and expertise rarely found elsewhere.
              </p>
            </div>
